...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Redstonexs/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="Redstonexs/sub2api"
...
Documentation=https://github.com/Redstonexs/sub2api
