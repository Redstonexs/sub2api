...
func (s *PaymentConfigService) UpdatePaymentConfig(ctx context.Context, req UpdatePaymentConfigRequest) error {
	...
	m := map[string]string{
		...
		SettingBalancePurchaseEnabled:            formatBoolOrEmpty(req.BalancePurchaseEnabled),
		SettingSubscriptionPurchaseEnabled:       formatBoolOrEmpty(req.SubscriptionPurchaseEnabled),
