...
const (
	...
	SettingBalancePurchaseEnabled      = "BALANCE_PURCHASE_ENABLED"
	SettingSubscriptionPurchaseEnabled = "SUBSCRIPTION_PURCHASE_ENABLED"
...
func (s *PaymentConfigService) GetPaymentConfig(ctx context.Context) (*PaymentConfig, error) {
	keys := []string{
		...
		SettingEnabledPaymentTypes, SettingBalancePayDisabled, SettingBalancePurchaseEnabled, SettingSubscriptionPurchaseEnabled,
		SettingBalanceRechargeMult, SettingSubscriptionUSDToCNYRate, SettingRechargeFeeRate, SettingLoadBalanceStrategy,
...
func (s *PaymentConfigService) parsePaymentConfig(vals map[string]string) *PaymentConfig {
	cfg := &PaymentConfig{
		...
		BalancePurchaseEnabled:      vals[SettingBalancePurchaseEnabled] != "false",
		SubscriptionPurchaseEnabled: vals[SettingSubscriptionPurchaseEnabled] != "false",
...
func (s *PaymentConfigService) UpdatePaymentConfig(ctx context.Context, req UpdatePaymentConfigRequest) error {
	...
	if req.BalancePurchaseEnabled != nil {
		m[SettingBalancePurchaseEnabled] = formatBoolOrEmpty(req.BalancePurchaseEnabled)
	}
	if req.SubscriptionPurchaseEnabled != nil {
		m[SettingSubscriptionPurchaseEnabled] = formatBoolOrEmpty(req.SubscriptionPurchaseEnabled)
	}
	if req.BalanceRechargeMultiplier != nil {
