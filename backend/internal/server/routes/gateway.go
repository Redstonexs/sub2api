...
func RegisterGatewayRoutes(
	...
	gemini.Use(middleware.APIKeyAuthWithSubscriptionGoogle(apiKeyService, subscriptionService, groupQoSService, cfg))
	...
	antigravityV1Beta.Use(middleware.APIKeyAuthWithSubscriptionGoogle(apiKeyService, subscriptionService, groupQoSService, cfg))
