...
func (h *AuthHandler) Register(c *gin.Context) {
	...
	if err := h.authService.VerifyCaptchaForRegister(c.Request.Context(), req.CaptchaToken, req.TurnstileToken, ip.GetClientIP(c), req.VerifyCode); err != nil {
		response.ErrorFrom(c, err)
		return
	}
...
func (h *AuthHandler) SendVerifyCode(c *gin.Context) {
	...
	// Turnstile 验证
	if err := h.authService.VerifyCaptcha(c.Request.Context(), req.CaptchaToken, req.TurnstileToken, ip.GetClientIP(c)); err != nil {
		response.ErrorFrom(c, err)
		return
	}
