...
// is followed by the three group QoS columns; created_at is always last.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 63, "arg-type table must include session_id, requested_reasoning_effort and the group QoS snapshot columns")
	...
	// session_id sits immediately before the three group QoS columns.
