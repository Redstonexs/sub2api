...
type GroupEdges struct {
	...
	// GroupViewGrants holds the value of the group_view_grants edge.
	GroupViewGrants []*GroupViewGrant `json:"group_view_grants,omitempty"`
...
// GroupViewGrantsOrErr returns the GroupViewGrants value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) GroupViewGrantsOrErr() ([]*GroupViewGrant, error) {
	if e.loadedTypes[6] {
		return e.GroupViewGrants, nil
	}
	return nil, &NotLoadedError{edge: "group_view_grants"}
}
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group.FieldVideoModelPrices, group.FieldModelPricing, group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig, group.FieldCodexModelsManifestConfig, group.FieldReasoningEffortMappings, group.FieldQosTiers:
			values[i] = new([]byte)
		case group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldAllowBatchImageGeneration, group.FieldImageRateIndependent, group.FieldVideoRateIndependent, group.FieldLongContextPricingEnabled, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldAllowLive, group.FieldForceOpenaiFast, group.FieldFreeOpenaiFast, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet, group.FieldProfitControlEnabled, group.FieldQosEnabled:
...
// QueryGroupViewGrants queries the "group_view_grants" edge of the Group entity.
func (_m *Group) QueryGroupViewGrants() *GroupViewGrantQuery {
	return NewGroupClient(_m.config).QueryGroupViewGrants(_m)
}
