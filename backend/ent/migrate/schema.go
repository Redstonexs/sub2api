...
var (
	...
	AnnouncementsColumns = []*schema.Column{
		...
		{Name: "show_banner", Type: field.TypeBool, Default: false},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "group_qos_tier", Type: field.TypeInt16, Nullable: true},
		{Name: "group_qos_window", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "group_qos_effect_mask", Type: field.TypeInt16, Nullable: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
