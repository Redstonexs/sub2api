...
// was not loaded in eager-loading.
func (e UserEdges) GroupViewGrantsOrErr() ([]*GroupViewGrant, error) {
	if e.loadedTypes[13] {
...
// QueryGroupViewGrants queries the "group_view_grants" edge of the User entity.
func (_m *User) QueryGroupViewGrants() *GroupViewGrantQuery {
	return NewUserClient(_m.config).QueryGroupViewGrants(_m)
}
