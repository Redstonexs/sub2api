...
const (
	// Label holds the string label denoting the usergroupqosusage type in the database.
	Label = "user_group_qo_susage"
	...
	// Table holds the table name of the usergroupqosusage in the database.
	Table = "user_group_qos_usages"
)

// Columns holds all SQL columns for usergroupqosusage fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the UserGroupQoSUsage queries.
