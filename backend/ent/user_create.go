...
func (_c *UserCreate) AddGroupViewGrantIDs(ids ...int64) *UserCreate {
	_c.mutation.AddGroupViewGrantIDs(ids...)
	return _c
}

// AddGroupViewGrants adds the "group_view_grants" edges to the GroupViewGrant entity.
func (_c *UserCreate) AddGroupViewGrants(v ...*GroupViewGrant) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddGroupViewGrantIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.GroupViewGrantsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
