...
// The GroupViewGrantFunc type is an adapter to allow the use of ordinary function as a Querier.
type GroupViewGrantFunc func(context.Context, *ent.GroupViewGrantQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f GroupViewGrantFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.GroupViewGrantQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.GroupViewGrantQuery", q)
}

// The TraverseGroupViewGrant type is an adapter to allow the use of ordinary function as Traverser.
type TraverseGroupViewGrant func(context.Context, *ent.GroupViewGrantQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseGroupViewGrant) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseGroupViewGrant) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.GroupViewGrantQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.GroupViewGrantQuery", q)
}
...
// The UserGroupQoSUsageFunc type is an adapter to allow the use of ordinary function as a Querier.
type UserGroupQoSUsageFunc func(context.Context, *ent.UserGroupQoSUsageQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f UserGroupQoSUsageFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.UserGroupQoSUsageQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.UserGroupQoSUsageQuery", q)
}

// The TraverseUserGroupQoSUsage type is an adapter to allow the use of ordinary function as Traverser.
type TraverseUserGroupQoSUsage func(context.Context, *ent.UserGroupQoSUsageQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseUserGroupQoSUsage) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseUserGroupQoSUsage) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.UserGroupQoSUsageQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.UserGroupQoSUsageQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.GroupViewGrantQuery:
		return &query[*ent.GroupViewGrantQuery, predicate.GroupViewGrant, groupviewgrant.OrderOption]{typ: ent.TypeGroupViewGrant, tq: q}, nil
	...
	case *ent.UserGroupQoSUsageQuery:
		return &query[*ent.UserGroupQoSUsageQuery, predicate.UserGroupQoSUsage, usergroupqosusage.OrderOption]{typ: ent.TypeUserGroupQoSUsage, tq: q}, nil
