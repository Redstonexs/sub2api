          ...
          <template #cell-location="{ row }">
            <div class="flex items-center gap-2">
              <span
                ...
                class="inline-flex items-center justify-center rounded bg-gray-100 px-1.5 py-0.5 text-xs font-semibold uppercase tracking-wide text-gray-600 dark:bg-dark-700 dark:text-dark-300"
              >
