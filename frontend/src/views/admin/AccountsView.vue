...
const handleBulkDelete = async () => {
  ...
  if (!(await confirm({ title: t('admin.accounts.bulkActions.delete'), message: t('admin.accounts.bulkActions.deleteConfirm', { count: accountIds.length }), danger: true }))) return
  try {
