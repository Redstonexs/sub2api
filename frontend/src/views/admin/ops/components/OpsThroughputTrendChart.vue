...
import { CHART_SERIES, chartChrome, chartTooltipStyle, withAlpha } from '@/utils/chartTheme'
...
const colors = computed(() => ({
  blue: CHART_SERIES[1],
  blueAlpha: withAlpha(CHART_SERIES[1], 0.125),
  green: CHART_SERIES[5],
  greenAlpha: withAlpha(CHART_SERIES[5], 0.125),
