...
export default {
  ...
  homeV2: {
    ...
    leaderboardDescription: 'Artificial Analysis scores every frontier model on the same nine evaluations. The Claude family holds the top of the Intelligence Index and GPT leads the rest of the field: state-of-the-art reasoning, agentic coding and long-context work.',
