...
export default {
  ...
  homeV2: {
    ...
    subtitle: 'Route requests to Claude, GPT, Gemini and more through a single gateway — with unified billing, quotas, and automatic failover.',
    ...
    diagramLabelKey: 'Your API key',
    diagramLabelGateway: 'Gateway',
    diagramLabelProviders: 'Providers',
    diagramStatus: 'Live routing',
    relayKicker: 'Request lifecycle',
    relayTitle: 'Watch one request become a reliable response.',
    relayDescription: 'The gateway receives the call, selects healthy capacity, and leaves a complete usage record without changing your SDK contract.',
    relayRequestEyebrow: 'Request in',
    relayRequestTitle: 'Keep the client contract intact.',
    relayRequestDescription: 'Send the API call your application already knows. One key and one endpoint enter the routing layer.',
    relayRouteEyebrow: 'Route live',
    relayRouteTitle: 'Choose capacity with context.',
    relayRouteDescription: 'Health, available capacity, sticky sessions, and fallback policy guide every upstream selection.',
    relayReceiptEyebrow: 'Receipt out',
    relayReceiptTitle: 'See every outcome clearly.',
    relayReceiptDescription: 'Usage, quota, balance, and provider outcomes return as an auditable operational record.',
    capabilityKicker: 'Gateway behavior',
    capabilityTitle: 'Built for the decisions between request and response.',
    capabilityDescription: 'Operational guarantees stay visible: routing, scheduling, billing, and continuity.',
    featGatewayTitle: 'One endpoint for everything',
    featGatewayDesc: 'Point your SDK at the gateway base URL and keep your existing code. Anthropic, OpenAI and Gemini API formats work out of the box.',
    featSchedulingTitle: 'Smart account scheduling',
    featSchedulingDesc: 'Requests spread across upstream accounts with health checks and automatic failover — no more babysitting rate limits.',
    featBillingTitle: 'Billing you can audit',
    featBillingDesc: 'Token-level usage accounting, per-key quotas and real-time balance tracking for every request.',
    featStickyTitle: 'Sticky sessions',
    featStickyDesc: 'Conversations stay pinned to the same upstream account, keeping context caches warm and latency low.',
    quickstartTitle: 'Ship in three steps',
    quickstartDescription: 'Keep the integration small: create a key, point the base URL, and use the models you already call.',
    quickstartStep1: 'Create a gateway API key',
    quickstartStep2: 'Point base_url at the gateway',
    quickstartStep3: 'Call any model, watch usage live',
    providersTitle: 'Supported providers',
    providersDesc: 'One API surface, many upstreams.',
    providerMore: 'More',
    providerSoon: 'Soon',
    ctaBandTitle: 'Start routing in minutes',
    ctaBandDesc: 'Self-hosted, open source, and ready for production.',
