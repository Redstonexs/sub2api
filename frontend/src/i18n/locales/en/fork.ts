...
export default {
  ...
  homeV2: {
    ...
    providerMore: 'More',
    providerSoon: 'Soon',
    leaderboardKicker: 'Independent benchmarks',
    leaderboardTitle: 'Claude and GPT sit at the frontier. Reach both with one key.',
    leaderboardDescription: 'Artificial Analysis scores every frontier model on the same nine evaluations. The Claude family holds the top of the Intelligence Index and GPT leads the rest of the field: state-of-the-art reasoning, agentic coding and long-context work, all reachable through this gateway.',
    leaderboardViewLive: 'Live leaderboard',
    leaderboardScoreLabel: 'Artificial Analysis Intelligence Index, 0-100',
    leaderboardScoreUnit: '/ 100',
    leaderboardRoutable: 'Routable here',
    leaderboardSnapshot: 'Snapshot taken {date}',
    leaderboardNote: 'Highest-scoring configuration per model family; the published board lists each reasoning-effort setting as its own row.',
    leaderboardStatLeaderLabel: 'Tops the index',
    leaderboardStatOpenAiLabel: 'Highest OpenAI model',
    leaderboardStatEvalsLabel: 'Evaluations aggregated',
