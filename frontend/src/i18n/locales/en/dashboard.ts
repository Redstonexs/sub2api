export default {
  dashboard: {
    ...
    groupQuotaCard: {
      ...
      grantCount: '{count} authorized',
      addUserById: 'Add user by ID',
      searchUserPlaceholder: 'Search by username, email, or user ID',
      searchUserEmpty: 'No matching users',
      alreadyGranted: 'Granted',
      grantRawUserId: 'Grant access to user #{id}',
      roleAdmin: 'Admin',
      userDisabled: 'Disabled',
      filterGrantedUsers: 'Filter authorized users',
      noMatchingGrants: 'No authorized users match this filter',
      add: 'Add',
      revoke: 'Revoke',
  ...
  usage: {
    ...
    qos: 'QoS',
    qosAffected: 'QoS changed',
    qosActive: 'QoS active',
    qosUnknown: 'QoS status unavailable for this record',
    qosTier: 'Tier {tier}',
