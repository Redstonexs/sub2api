export default {
    settings: {
      ...
      antigravityOAuth: {
        title: 'Antigravity OAuth credentials',
        description: 'Set the client identity used when authorizing Antigravity accounts.',
        clientId: 'Client ID',
        clientIdPlaceholder: 'OAuth client ID',
        clientSecret: 'Client secret',
        clientSecretPlaceholder: 'Enter a new secret to replace the current one',
        clientSecretHint: 'Write-only. Leave blank to keep the current secret.',
        encryptionWarning: 'Add TOTP_ENCRYPTION_KEY to the server environment, restart the service, then save these credentials. Until then, saving is unavailable.',
        reauthorizationWarning: 'Changing credentials may require Antigravity accounts to be reauthorized.',
        saved: 'Antigravity OAuth credentials saved',
        saveFailed: 'Failed to save Antigravity OAuth credentials',
        loadFailed: 'Failed to load Antigravity OAuth credentials',
        retry: 'Retry',
        clear: 'Clear panel configuration',
        clearConfirm: 'Clear the panel-managed Antigravity OAuth override? Environment credentials, if configured, will remain available.',
        cleared: 'Panel configuration cleared',
        clearFailed: 'Failed to clear panel configuration',
        sourceLabel: 'Source',
        secretStatusLabel: 'Secret',
        validLabel: 'Validity',
        ...
        status: {
          ...
          none: 'Not configured',
          settingsInvalid: 'Panel configuration invalid',
          environmentInvalid: 'Environment configuration invalid',
        },
      },
      webSearchEmulation: {
      ...
      payment: {
        ...
        balancePurchaseEnabled: 'Open Balance Purchases',
        balancePurchaseEnabledHint: 'Allow users to buy account balance through payment providers.',
        subscriptionPurchaseEnabled: 'Open Subscription Purchases',
        subscriptionPurchaseEnabledHint: 'Allow users to buy subscription plans through payment providers.',
        subscriptionPlansHint: 'Choose the subscription plans available for sale from the plan management page.',
        ...
        field_paymentCurrencyHint: 'Default is CNY. Stripe, Airwallex, and HashPay can choose HKD, USD, or another listed currency supported by the account; WeChat Pay, Alipay, and EasyPay remain CNY.',
        ...
        field_hashpayApiBaseHint: 'Use your deployed HashPay origin. The /api suffix is optional.',
        field_hashpayPrivateKeyHint: 'Paste the PEM merchant private key shown once when HashPay creates or rotates the merchant. Keep it secret; do not paste the public key.',
        showSensitiveField: 'Show {field}',
        hideSensitiveField: 'Hide {field}',
        ...
        hashpayWebhookHint: 'Configure the following URL as the callback URL for this HashPay merchant. HashPay encrypts each callback with the merchant public key.',
