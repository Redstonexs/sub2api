export default {
    ...
    dashboard: {
      ...
      groupQuotaCard: {
        title: 'Group Quota Overview',
        selectGroup: 'Select group',
        noViewableGroups: 'No groups available to view',
        totalRemaining5h: 'Total 5h Remaining',
        totalRemaining7d: 'Total 7d Remaining',
        perAccountUsage: 'Account Usage',
        accountLabel: 'Account {n}',
        noData: '—',
        noAccounts: 'No accounts in this group',
        sortBy5h: 'By 5h remaining',
        sortBy7d: 'By 7d remaining',
        loading: 'Loading quota data...',
        loadFailed: 'Failed to load quota data',
        resetsAt: 'Resets {time}',
        grantManagement: 'View Access Management',
        grantedUsers: 'Authorized Users',
        addUserById: 'Add user by ID',
        add: 'Add',
        revoke: 'Revoke',
        noGrantedUsers: 'No users authorized yet',
        grantSuccess: 'View access granted',
        revokeSuccess: 'View access revoked',
    ...
    groups: {
      ...
      form: {
        ...
        qosEnabled: 'QoS degradation ladder',
        qosEnabledHint: 'When a user\u2019s spend in this group crosses a tier threshold, serve them progressively cheaper models instead of cutting them off at a hard limit. Counting starts when you enable this \u2014 past spend is not backfilled.',
        qosMetric: 'Threshold metric',
        qosMetricHint: 'List cost counts undiscounted price, so a deep group discount cannot mask heavy consumption. Charged cost counts what the user actually paid.',
        qosMetricOption: {
          list: 'Undiscounted list cost',
          charged: 'Charged cost (balance spent)',
        },
        qosTiers: 'Tiers',
        qosTiersHint: 'Ordered by increasing severity. The highest tier the user has reached applies in full.',
        qosTiersEmpty: 'No tiers yet. Add one to start degrading heavy users.',
        qosTierLabel: 'Tier {index}',
        addQosTier: 'Add tier',
        removeQosTier: 'Remove tier',
        qosWindow: 'Window',
        qosWindowOption: {
          daily: 'Daily',
          weekly: 'Weekly',
        ...
        qosThreshold: 'Threshold (USD)',
        qosNoChange: 'No change',
        qosMaxReasoningEffort: 'Cap reasoning effort',
        qosRpmLimit: 'Cap requests per minute',
        qosBlock: 'Block requests',
        qosBlockHint: 'The final rung: reject requests outright until the window resets.',
        qosModelMappings: 'Model reroutes',
        qosModelFrom: 'Requested model',
        qosModelTo: 'Served model',
        qosModelFromPlaceholder: 'gpt-5.6-sol* (trailing * matches a prefix)',
        qosModelToPlaceholder: 'gpt-5.6-luna',
        addQosModelMapping: 'Add reroute',
        removeQosModelMapping: 'Remove reroute',
        qosError: {
          windowRequired: 'Select a window',
          thresholdInvalid: 'Enter a threshold of 0 or more',
          thresholdNotAscending: 'Threshold must be greater than the previous tier for the same window',
          noAction: 'Add at least one action to this tier',
          tooManyTiers: 'Too many tiers (max 16)',
          tooManyMappings: 'Too many reroutes (max 64)',
          rpmInvalid: 'Enter a whole number of 0 or more',
          effortUnsupported: 'Reasoning effort is not supported by this platform',
          fromRequired: 'Enter the requested model',
          toRequired: 'Enter the served model',
          duplicateFrom: 'Requested model must be unique within a tier',
          wildcardTarget: 'Served model cannot contain a wildcard',
        },
