  ...
  admin: {
    ...
    settings: {
      ...
      gatewayErrorMessages: {
        ...
        description: 'Customize user-facing error messages returned by the gateway for specific HTTP status codes.',
        label: 'Custom error messages',
        placeholder: `{'{'}"429": "Too many requests, please retry later.", "502": "The upstream service is temporarily unavailable."{'}'}`,
        hint: `Enter a JSON object mapping 3-digit HTTP status codes to custom messages. Leave empty or use {'{}'} to keep defaults.`,
        invalid: 'Invalid gateway error messages: {message}',
      },
