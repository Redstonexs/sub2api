export default {
    settings: {
      ...
      antigravityOAuth: {
        title: 'Antigravity OAuth 凭据',
        description: '设置 Antigravity 账号授权时使用的客户端身份。',
        clientId: 'Client ID',
        clientIdPlaceholder: 'OAuth 客户端 ID',
        clientSecret: 'Client secret',
        clientSecretPlaceholder: '填写新密钥以替换当前密钥',
        clientSecretHint: '密钥仅写入不回显。留空表示保留当前密钥。',
        encryptionWarning: '请在服务器环境变量中配置 TOTP_ENCRYPTION_KEY，重启服务后再保存凭据。配置前无法保存。',
        reauthorizationWarning: '修改凭据后，Antigravity 账号可能需要重新授权。',
        saved: 'Antigravity OAuth 凭据已保存',
        saveFailed: '保存 Antigravity OAuth 凭据失败',
        loadFailed: '加载 Antigravity OAuth 凭据失败',
        retry: '重试',
        clear: '清除面板配置',
        clearConfirm: '清除面板管理的 Antigravity OAuth 覆盖配置？如已配置环境变量凭据，仍会继续可用。',
        cleared: '面板配置已清除',
        clearFailed: '清除面板配置失败',
        sourceLabel: '来源',
        secretStatusLabel: '密钥',
        validLabel: '有效性',
        configured: '已配置',
        notConfigured: '未配置',
        valid: '有效',
        ...
        status: {
          ...
          environment: '使用环境变量',
          none: '未配置',
          settingsInvalid: '面板配置无效',
          environmentInvalid: '环境变量配置无效',
        },
      },
      webSearchEmulation: {
        title: 'Web Search 模拟',
      ...
      payment: {
        ...
        balancePurchaseEnabled: '开放余额购买',
        balancePurchaseEnabledHint: '允许用户购买余额。',
        subscriptionPurchaseEnabled: '开放订阅购买',
        subscriptionPurchaseEnabledHint: '允许用户购买订阅。',
        subscriptionPlansHint: '请到套餐管理中选择可售订阅套餐。',
        manageSubscriptionPlans: '管理订阅套餐',
        ...
        subscriptionUsdToCnyRateHint:
          'CNY 通道中，每 1 USD 套餐价格收取多少 CNY（如 7.15）。不换算时请留空或填 0；启用后套餐价格必须为 USD。',
        ...
        field_paymentCurrencyHint: '默认 CNY。Stripe、Airwallex 和 HashPay 可选择账户支持的 HKD、USD 等币种；微信、支付宝、易支付仍按 CNY。',
        field_accountIdHint: '不涉及多账户、组织级密钥或连接账户收款时可以不填；单账户 Scoped API Key 会默认使用所选账户。',
        field_hashpayApiBaseHint: '填写已部署的 HashPay 服务地址；末尾的 /api 可填可不填。',
        field_hashpayPrivateKeyHint: '填写 HashPay 创建或轮换商户时仅展示一次的 PEM 商户私钥。请妥善保管，不要填写公钥。',
        showSensitiveField: '显示{field}',
        hideSensitiveField: '隐藏{field}',
        field_cid: '支付渠道 ID',
        ...
        hashpayWebhookHint: '请在该 HashPay 商户的回调地址中填写以下 URL。HashPay 会使用商户公钥加密每次回调。',
