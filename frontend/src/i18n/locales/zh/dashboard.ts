export default {
  dashboard: {
    ...
    groupQuotaCard: {
      ...
      grantedUsers: '已授权用户',
      grantCount: '已授权 {count} 人',
      addUserById: '按用户ID添加',
      searchUserPlaceholder: '搜索用户名、邮箱或用户ID',
      searchUserEmpty: '未找到匹配的用户',
      alreadyGranted: '已授权',
      grantRawUserId: '直接授权用户 #{id}',
      roleAdmin: '管理员',
      userDisabled: '已禁用',
      filterGrantedUsers: '筛选已授权用户',
      noMatchingGrants: '没有匹配的已授权用户',
      add: '添加',
      revoke: '移除',
