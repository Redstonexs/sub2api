...
export default {
  ...
  homeV2: {
    eyebrow: 'AI API 网关',
    title: '一把密钥，通向所有模型。',
    subtitle: '通过单一网关将请求路由至 Claude、GPT、Gemini 等模型——统一计费、配额管理与自动故障转移。',
    ctaStart: '立即开始',
    ctaDashboard: '进入控制台',
    ctaDocs: '阅读文档',
    navDocs: '文档',
    ...
    themeToDark: '切换到深色模式',
    diagramLabelKey: '你的 API 密钥',
    diagramLabelGateway: '网关',
    diagramLabelProviders: '上游模型',
    diagramStatus: '实时路由',
    relayKicker: '请求生命周期',
    relayTitle: '看见一次请求如何成为可靠响应。',
    relayDescription: '网关接收调用、选择健康容量并留下完整用量记录，全程无需改变现有 SDK 契约。',
    relayRequestEyebrow: '请求进入',
    relayRequestTitle: '保留客户端原有契约。',
    relayRequestDescription: '继续发送应用已熟悉的 API 调用。一把密钥、一个端点，进入统一路由层。',
    relayRouteEyebrow: '实时路由',
    relayRouteTitle: '结合上下文选择容量。',
    relayRouteDescription: '健康状态、可用容量、会话保持与故障转移策略共同决定每一次上游选择。',
    relayReceiptEyebrow: '结果回执',
    relayReceiptTitle: '清晰查看每一个结果。',
    relayReceiptDescription: '用量、配额、余额与上游结果会返回为可审计的运营记录。',
    capabilityKicker: '网关能力',
    capabilityTitle: '专注请求与响应之间的关键决策。',
    capabilityDescription: '路由、调度、计费与会话连续性等运营保障始终清晰可见。',
    featGatewayTitle: '一个端点，接入一切',
    featGatewayDesc: '将 SDK 的 Base URL 指向网关即可，无需改动现有代码。原生兼容 Anthropic、OpenAI 与 Gemini API 格式。',
    featSchedulingTitle: '智能账号调度',
    featSchedulingDesc: '请求在多个上游账号间智能分配，自带健康检查与自动故障转移，从此告别手动盯限流。',
    featBillingTitle: '可审计的计费',
    featBillingDesc: 'Token 级用量核算，按密钥配额管理，每一笔请求的余额变动实时可查。',
    featStickyTitle: '会话保持',
    featStickyDesc: '同一会话固定路由至同一上游账号，缓存持续命中，延迟更低。',
    quickstartTitle: '三步接入',
    quickstartDescription: '接入保持简单：创建密钥、指向网关 Base URL，然后继续调用已在使用的模型。',
    quickstartStep1: '创建网关 API 密钥',
    quickstartStep2: '将 base_url 指向网关',
    quickstartStep3: '调用任意模型，实时查看用量',
    providersTitle: '已支持的上游',
    providersDesc: '一个 API 界面，多个上游模型。',
    providerMore: '更多',
    providerSoon: '即将推出',
    ctaBandTitle: '几分钟内开始路由',
    ctaBandDesc: '开源自托管，生产可用。',
    ctaBandBtn: '创建你的密钥',
