...
// (independent 1.1.x+ VERSION line), not upstream Wei-Shaw/sub2api.
const GITHUB_REPO = 'Redstonexs/sub2api'
// GHCR image published by this fork's release CI (tags carry no "v" prefix,
// e.g. ghcr.io/redstonexs/sub2api:1.2.0)
const DOCKER_IMAGE = 'ghcr.io/redstonexs/sub2api'
