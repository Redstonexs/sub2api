        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
          ...
          <div class="mt-2 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <span class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.accounts.gemini.oauthType.personalQuota') }}
                </span>
                <div class="mt-2 flex flex-wrap gap-1">
                  ...
                  >
                    {{ t('admin.accounts.gemini.oauthType.noGcp') }}
                  </span>
                </div>
              </div>
            </button>
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <span class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.accounts.gemini.oauthType.enterpriseGcp') }}
                </span>
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.accounts.gemini.oauthType.enterpriseGcpHint') }}
                  <a
          ...
          <div class="mt-3">
            ...
            >
              ...
              <span>{{ showAdvancedOAuth ? t('admin.accounts.gemini.oauthType.hideAdvancedOAuth') : t('admin.accounts.gemini.oauthType.showAdvancedOAuth') }}</span>
            </button>
          </div>
          ...
          <div>
            ...
            <div class="mt-2 flex flex-wrap gap-2">
              ...
              <a
                ...
                class="text-sm text-blue-600 hover:underline dark:text-blue-400"
              >
                {{ t('admin.accounts.gemini.oauthType.changeRegion') }}
              </a>
              <span class="text-gray-400">·</span>
              <a
