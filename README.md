...
- **Built-in Payment System** - Supports EasyPay, Alipay, WeChat Pay, Stripe, and HashPay for user self-service top-up, no separate payment service needed ([Configuration Guide](docs/PAYMENT.md))
